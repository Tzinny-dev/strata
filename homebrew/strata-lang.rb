class StrataLang < Formula
  ...
  version "0.1.3"
  if OS.mac?
    url "https://github.com/Tzinny-dev/strata/releases/download/v0.1.3/strata-macos-amd64"
    sha256 "32a9dffd93c17a2d575e87d3abc492326a9e0071447bb5328ed33448054f6e45"
  elsif OS.linux?
    url "https://github.com/Tzinny-dev/strata/releases/download/v0.1.3/strata-linux-amd64"
